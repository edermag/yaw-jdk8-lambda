...
/**
 * Demonstracao de como tirar proveito de lambda expressions com as colecoes do Java.
 */
public class TesteColecaoDeAlunos {
	...
	public static void main(String args[]){
		...
		out.println("---------------\nAprovados:");
		alunos.filter(a -> a.getNota() > 5).forEach(a -> { out.println("\t" + a); });

		//copiando dados filtrados de uma colecao pra outra
		List<Aluno> aprovados = alunos.filter(a -> a.getNota() > 5).into(new ArrayList<Aluno>());
